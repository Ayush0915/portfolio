...
export default function Home() {
  return (
    <div className="grid min-h-[80vh] grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,1fr)_440px] lg:gap-12">
      <section className="flex flex-col justify-center">
        ...
        <motion.p {...anim(0.32)} className="mb-10 max-w-lg text-base leading-relaxed text-zinc-400">
          I am Ayush Kumar Bhadani, a final-year CSE (Data Science) student at Bangalore Institute of Technology (9.45 CGPA). I specialize in deep learning architectures, Transformer fine-tuning, and semantic retrieval. I bridge statistical ML models with production systems—building optimized RAG pipelines, agentic workflows, and neural networks.
        </motion.p>
