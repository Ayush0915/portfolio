      ...
      <AnimatePresence mode="wait">
        {!isOpen && (
          ...
          >
            ...
            >
              Ask me about Ayush&apos;s projects & background
            </motion.div>
        ...
        {isOpen && (
          ...
          <div className="flex items-center justify-between p-4 border-b border-zinc-800">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-zinc-100">Ayush&apos;s Assistant</h3>
            </div>
            <button
                ...
                >
                  ...
                  >
                    <div className="break-words whitespace-pre-wrap">
                      Hey there! 👋 I&apos;m here to help you learn about Ayush, a final-year CS (Data Science) student who builds AI/ML systems — multi-agent pipelines, RAG, and full ML workflows.

What would you like to know? Ask about projects like CodeVerdict or CareerIQ, his skills, education, or anything else!
                    </div>
                  </motion.div>
                </motion.div>
              </>
